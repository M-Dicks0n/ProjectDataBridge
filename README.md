...
Project DataBridge started as a simple weather scraping application and has since been expanded into a multi-location ETL (Extract, Transform, Load) pipeline. The latest release adds richer meteorological metrics and a CSV export layer designed to feed into Ensemble, a companion R-based wardrobe recommendation model.
